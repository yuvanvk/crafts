  ...
  return (
    <div className="flex flex-col w-115 p-5">
      ...
      <div className="space-y-3">
        ...
        <p className="text-[16px] font-playfair-display text-gray-500 dark:text-gray-400 italic tracking-tighter">
        ...
        <div className="flex items-center gap-x-3 font-playfair-display font-semibold">
          <button className="border-2 px-4 py-1  rounded-xl border-gray-200 dark:border-neutral-500 hover:border-neutral-600 text-[15px] cursor-pointer italic transition duration-300">
            Book a call
          </button>
          <button className="bg-black dark:bg-white dark:text-black hover:bg-neutral-800 hover:dark:bg-gray-200 text-white px-5 py-1.5 rounded-xl text-[14px] italic cursor-pointer tracking-tight transition duration-300">
            $9k/mo →
          </button>
        </div>
      </div>
